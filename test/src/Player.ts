...
class MoveState implements State{
    ...
    constructor(player: Player, path: tile[]) {
        ...
        let temp = ["tq-1.png", "tq-2.png", "tq-3.png", "tq-4.png", "tq-1.png", "tq-2.png", "tq-3.png", "tq-4.png", "tq1.png", "tq2.png", "tq3.png", "tq4.png", "tq1.png", "tq2.png", "tq3.png", "tq4.png"];
...
class IdleState implements State{
    ...
    constructor(player:Player){
        ...
        this.count=0;
        this.sequenceOver=false;
        let temp=["jz.png","jz2.png","jz3.png","jz4.png"];
...
class FightState implements State{
    ...
    constructor(player:Player,monster:Monster){
        ...
        this.count=0;
        this.sequenceOver=false;
        let temp=["jz1.png","jz2.png","jz3.png","jz4.png"];
