...
var npc_0: NPC = new NPC("npc_0", "jz1.png");
npc_0.x = 128;
npc_0.y = 128;
stage.addChild(npc_0);

var npc_1: NPC = new NPC("npc_1", "tq1.png");
npc_1.x = 576;
npc_1.y = 576;
stage.addChild(npc_1);

var monster: Monster = MonsterFactory.createOneMonster("mush_bad.jpg");
monster.x = 256;
monster.y = 256;
...
var equipment: Equipment = new Equipment(10, "axe.jpg");
var equipment1: Equipment = new Equipment(20, "armor.jpg");
var equipment2: Equipment = new Equipment(999, "bracelet.jpg");
